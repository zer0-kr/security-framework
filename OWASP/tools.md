...
| 나는 이런 게 필요하다 | 추천 도구 |
|---------------------|----------|
| OWASP 전체 데이터를 AI로 검색하고 싶다 | **zer0-kr/owasp-mcp** |
| 기술 스택에 맞는 보안 가이드가 필요하다 | **zer0-kr/owasp-mcp** (`assess_stack`) |
| STRIDE 위협 모델링을 자동화하고 싶다 | **zer0-kr/owasp-mcp** (`threat_model`) |
| MCP 서버의 보안을 점검하고 싶다 | **zer0-kr/owasp-mcp** (`assess_mcp_security`) |
| ASVS를 PCI-DSS/ISO 27001에 매핑하고 싶다 | **zer0-kr/owasp-mcp** (`compliance_map`) |
