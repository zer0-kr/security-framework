...
| 도구 | 설명 | 인증 | URL |
|------|------|------|-----|
| **NVD API 2.0** | CVE 취약점, CPE 제품 정보를 REST API로 조회. 346,000+ CVE 수록 | API Key 권장 (무료) | https://nvd.nist.gov/developers |
...
| MCP | 커버리지 | 특징 | GitHub |
|-----|---------|------|--------|
| **ball2jh/nist-mcp** | SP 800/1800, IR, FIPS, CSWP, SP 800-53, CSF 2.0, NVD, CMVP, 용어사전, NICE | 가장 넓은 커버리지. 로컬 SQLite. PDF→Markdown 변환 | [GitHub](https://github.com/ball2jh/nist-mcp) |
...
| MCP | 커버리지 | 특징 | GitHub |
|-----|---------|------|--------|
| **rocklambros/nist-csf-2-mcp-server** | CSF 2.0 (6 Functions, 185 Subcategories) | 740개 평가 질문, 40+ 도구, 대시보드. NIST 공식 커뮤니티 리소스 등재 | [GitHub](https://github.com/rocklambros/nist-csf-2-mcp-server) |
