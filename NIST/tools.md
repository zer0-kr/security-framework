...
| MCP | 커버리지 | 특징 | GitHub |
|-----|---------|------|--------|
| **ball2jh/nist-mcp** | SP 800/1800, IR, FIPS, CSWP, SP 800-53, CSF 2.0, NVD, CMVP, 용어사전, NICE | NIST 전문. 로컬 SQLite. PDF→Markdown 변환 | [GitHub](https://github.com/ball2jh/nist-mcp) |
...
| NIST 문서를 검색하고 PDF 내용을 읽고 싶다 | **ball2jh/nist-mcp** |
