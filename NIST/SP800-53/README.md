...
SP 800-53A는 각 컨트롤이 **올바르게 구현되었는지 검증하는 방법**을 정의합니다. SP 800-53의 모든 컨트롤과 Enhancement에 대해 1:1로 평가 절차가 존재합니다.
...
> 상세 내용(평가 절차 구조, 예시, RMF와의 관계 등)은 [SP 800-53A 상세 문서](./assessment.md)를 참고하세요.
...
세 가지 보안 목표(C/I/A)의 영향도 중 **가장 높은 것**이 시스템의 전체 영향도가 됩니다.
...
| 기준선 | 컨트롤 수 | 체크리스트 |
|--------|----------|-----------|
| **LOW** | 149개 | [LOW 체크리스트](./low.md) |
| **MODERATE** | 287개 (+138) | [MODERATE 체크리스트](./moderate.md) |
| **HIGH** | 370개 (+83) | [HIGH 체크리스트](./high.md) |
| **PRIVACY** | 별도 | — |
