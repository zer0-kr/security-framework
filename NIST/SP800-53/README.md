...
|--------|--------|----------|----------|-----------|
| **LOW** | 제한적 피해 | 149개 | 기밀성/무결성/가용성 손실 시 피해가 제한적 | [LOW 체크리스트](./baseline-low.md) |
| **MODERATE** | 심각한 피해 | 287개 | 피해가 심각한 수준 | [MODERATE 체크리스트](./baseline-moderate.md) |
| **HIGH** | 치명적 피해 | 370개 | 피해가 치명적/재앙적 | [HIGH 체크리스트](./baseline-high.md) |
