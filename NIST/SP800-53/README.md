...
|------|------|
| 컨트롤 패밀리 | 20개 |
| Base 컨트롤 (비-enhancement, 비-withdrawn) | 300개 |
| 컨트롤 Enhancement | 714개 |
| Withdrawn (폐지) 컨트롤 | 182개 |
...
> PM 패밀리는 기준선에 포함되지 않습니다. 조직 수준에서 정보보안/프라이버시 프로그램 관리를 위해 적용됩니다.
...
<details>
<summary><b>PT — PII Processing and Transparency (8 base / 13 enhancement)</b></summary>

> PT 패밀리는 기준선에 포함되지 않습니다. PII를 처리하는 시스템에 Privacy Baseline으로 적용됩니다. **Rev. 5에서 신설.**
