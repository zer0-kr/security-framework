...
```mermaid
flowchart TD
    CSF["<b>CSF 2.0</b><br/>Cybersecurity Framework<br/><i>무엇을 해야 하는가</i>"]
    PF["<b>Privacy Framework</b><br/><i>프라이버시 리스크 관리</i>"]
    CTRL["<b>SP 800-53</b><br/>보안/프라이버시 컨트롤 카탈로그<br/>20 Families · 1,196 Controls"]
    ASSESS["<b>SP 800-53A</b><br/>컨트롤 평가 절차"]
    BASE["<b>SP 800-53B</b><br/>기준선(Baselines)<br/>LOW · MODERATE · HIGH"]
    SP800["<b>SP 800 시리즈</b><br/>주제별 상세 가이드<br/>RMF · CUI · 침해대응 · 암호 · ZTA 등"]
    SP1800["<b>SP 1800 시리즈</b><br/>실무 구현 가이드 (How-To)<br/>실제 환경에서의 구현 방법론 + 사례"]
    FIPS["<b>FIPS</b><br/>연방 표준 (의무 준수)<br/>AES · SHA · 암호모듈 등"]
...
> **읽는 법:** 위에서 아래로 추상화 수준이 낮아집니다. CSF가 "무엇을"을 정의하면, SP 800-53이 "어떤 통제를"로 구체화하고, SP 800 시리즈가 "어떻게"를 설명하며, SP 1800이 "실제 구현 사례"를 보여줍니다.
