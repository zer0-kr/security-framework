...
> ⚠️ 이 프로젝트는 NIST 공식 자료가 아닌 **비공식 학습 자료**입니다. 정확한 내용은 반드시 [NIST 원문](https://csrc.nist.gov)을 확인하세요.
...
| **SP 800-37 (RMF)** | 위험관리 프레임워크 — 7단계, 47 Tasks | [상세](./NIST/SP800-37/README.md) |
...
| **SP 800-53B 기준선** | LOW (149) · MODERATE (287) · HIGH (370) 체크리스트 | [LOW](./NIST/SP800-53/low.md) · [MOD](./NIST/SP800-53/moderate.md) · [HIGH](./NIST/SP800-53/high.md) |
| **SP 800 전체 목록** | 209건 주제별 분류 + 한국어 요약 | [상세](./NIST/SP800/README.md) |
| **SP 1800 전체 목록** | 37건 실무 구현 가이드 + 한국어 요약 | [상세](./NIST/SP1800/README.md) |
...
오류 발견, 내용 보강, 번역 개선 등은 Issue 또는 PR로 알려주세요.

## 라이선스

이 프로젝트의 콘텐츠는 [CC BY-NC-SA 4.0](./LICENSE) 라이선스로 제공됩니다. NIST 원문은 미국 정부 저작물로서 퍼블릭 도메인입니다.
